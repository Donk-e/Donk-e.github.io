...
<html lang = "en-UK">
    ...
    <div class = "flexRow">
         <div class="stickyNoteContainer">
            ...
            <p>Use the start button to easily navigate the site.</p>
        ...
        <div class = "windowContainer" style = "width: 65%; height: 80%">
            ...
            <p>I've been making games for 4 years, mainly in Unity but I have dabbled in Unreal. My main focus is on programming player focused gameplay systems, I approach my systems from a designers point of view as well as that of a programmer allowing me to create mechanics that create fun experiences for the player. </p>
